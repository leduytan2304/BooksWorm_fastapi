...
const OnSale = () => {
  ...
  return (
    ...
    >
      ...
      {/* slider buttons */}
      <div className="flex justify-end items-center mb-8 p-8 border border-solid border-gray-400">
        <button
          onClick={prevProject}
          className="p-3 bg-gray-200 rounded mr-2"
          aria-label="Prevuis Project"
        >
          <img class="w-8 h-8" src={assets.left_arrow} alt="Previous" />
        </button>
...
duration-500 ease-in-out "
        ...
        >
          <img className="w-8 h-8" src={assets.right_arrow} alt="Next" />
        </button>
      </div>
